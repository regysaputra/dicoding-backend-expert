...
describe('UserRepositoryPostgres', () => {
  ...
  describe('addUser function', () => {
    it('should persist register user and return registered user correctly', async () => {
      ...
      // Assert
      const users = await UsersTableTestHelper.findUsersById(id);
  ...
  describe('getIdByUsername', () => {
    ...
    it('should return user id correctly', async () => {
      // Arrange
      await UsersTableTestHelper.addUser({ id: '01890f2f-7b6e-7a2a-8f4b-3d8a1e2c4f91', username: 'dicoding' });
      const userRepositoryPostgres = new UserRepositoryPostgres(pool, {});
      ...
      // Assert
      expect(userId).toEqual('01890f2f-7b6e-7a2a-8f4b-3d8a1e2c4f91');
    });
  });
});
